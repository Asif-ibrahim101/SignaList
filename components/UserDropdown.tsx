        ...
        <div>
            <DropdownMenu>
                ...
                <DropdownMenuContent className="text-gray-400">
                    ...
                    <DropdownMenuItem onClick={handle_Signout} className="text-gray-100 text-md font-medium focus:bg-transparent focus:text-yellow-500 transition-colors cursor-pointer">
